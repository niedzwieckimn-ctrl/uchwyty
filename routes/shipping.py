...
def register_routes(context):
    ...
    def inpost_tracking_webhook():
        ...
        try:
            ...
            c.close()
        result = apply_verified_inpost_status(order, remote_shipment)
