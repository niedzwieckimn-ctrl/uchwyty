...
PILOT_POLICIES = FULFILLMENT_POLICIES + (
    ...
    ("policy-business-orders-state", "business.orders.state", 1, "orders.fulfillment_read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ("policy-business-inventory-state", "business.inventory.state", 1, "inventory.replenishment_read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ("policy-business-finance-state", "business.finance.state", 1, "invoices.read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ("policy-business-deliveries-state", "business.deliveries.state", 1, "purchases.read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ("policy-business-daily-state", "business.daily.state", 1, "business.generic_read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ...
    ("policy-inventory-replenishment-ranking", "inventory.replenishment.ranking", 1, "inventory.replenishment_read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ...
    ("policy-inventory-adjust", "inventory.adjust", 1, "inventory.adjust", YELLOW, 1, "approvals.decide", 3600, 0, None, 1),
    ...
    ("policy-shipment-read", "shipment.read", 1, "orders.read_full", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ...
    ("policy-payment-reminders-read", "payments.reminders.read", 1, "payments.read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ("policy-payment-reminders-send", "payments.reminders.send", 1, "payments.remind", YELLOW, 1, "approvals.decide", 1800, 0, None, 1),
    ("policy-search-analytics-read", "search.analytics.read", 1, "reports.read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ("policy-cashflow-read", "cashflow.read", 1, "cashflow.read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ...
    ("policy-china-orders-search", "china.orders.search", 1, "purchases.read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
    ("policy-china-orders-get", "china.orders.get", 1, "purchases.read", GREEN, 0, "approvals.decide", 3600, 1, None, 1),
